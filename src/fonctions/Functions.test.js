/**
 * 
 *      On ecrit a present la fonction qui doit prendre un mot et une expression en parametre et puis dire si le mot appartient bien a l'expression reguliere
 *      CETTE FONCTION C'EST COMPLETEMET LE PLAGEAT => PAS RESPONSABLE
 * 
 */

function isCorrectExpression(langage, input){ // Pour l'instant, on tient beaucoup plus compte de la concatenation
    flag = false; // contient le resultat de l'operation, true or false
    var postfix = postFixer(langage); // Prend la forme infixe et retourne sa forme postfixe pour le travail
